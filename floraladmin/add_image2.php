...
<div class="product-model">	 
	 <div class="container">
        ...
        <div class="container span_1_of_2">
                  <?php if(($_SESSION['image_status1'])==1){?> 
                  <div class="div_input">
                    <div class="container">
                        <div class="content">
                ...
                <div class="div_input">
                <a href="add_image1.php" class="abutton">BACK</a>
               
                <a href="add_image3.php" class="abutton">NEXT</a><?php }else{ echo "<p class='req'>IMAGE 1 is not Uploaded. Click back to Upload IMAGE 1</p>";?><br><a href="add_image1.php" class="abutton">BACK</a><?php }?>
                </div>
		</div>
    </div>
</div>                
