...
<div class="product-model">	 
	 <div class="container">
        ...
        <div class="container span_1_of_2">
                 <?php if(($_SESSION['image_status3'])==1){?> 
                  <div class="div_input">
                    <div class="container">
                        <div class="content">
                ...
                <a href="image_add.php?adminmsg=0" class="abutton">FINISH</a>
                <?php }else{ echo "<p class='req'>IMAGE 3 is not Uploaded. Click back to Upload IMAGE 3</p>";?> <br><a href="add_image3.php" class="abutton">BACK</a><?php }?>
                </div>
		</div>
	</div>
</div>
