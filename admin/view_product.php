                                            ...
                                            while ($image_row = mysqli_fetch_assoc($image_result)) {
                                                ...
                                                <div class=" col-lg-3 col-md-3 pull-right">
                                                    <div class="hovereffect">
                                                        <img class="img-responsive thumbnail" src="product_images/<?= $image_row['image_name'] ?>" alt="Chloris Product Image">
                                                        <div class="overlay">
                ...
                <div id="uploadmodal" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <form id="uploadForm" role="form" method="post" action="single_image_upload.php" enctype="multipart/form-data">
