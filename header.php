              ...
              <div class="container">
                <div class="collapse navbar-collapse" id="navbar">
                    <ul class="nav navbar-nav menu">
                        ...
                        <li <?php if ($filename == 'product.php') { ?> class="active" <?php } ?>><a href="product.php">SHOP</a></li>
                        <li <?php if ($filename == 'classes.php') { ?> class="active" <?php } ?>><a href="classes.php">CLASSES</a></li>
                    ...
                    <!-- <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="#"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
                                                    <button type="button" data-toggle="modal" data-target="#myModal" id="viewcart" class="btn btn-primary active cart">View Cart</button>
                </div>
            </div></div>
        </nav>
