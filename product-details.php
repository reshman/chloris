                ...
                <div class="col-md-12 det">
                    <div class="single_left">
                        <div class="flexslider">
                            <ul class="slides">
                                <?php
                                $sqlImage = sprintf("SELECT image_name FROM product_image WHERE product_id=%d", $_GET['id']);
                                $resultImage = mysqli_query($link, $sqlImage);
                                if (mysqli_num_rows($resultImage) > 0) {
                                    while ($rowImage = mysqli_fetch_assoc($resultImage)) {
                                        ?>
                                        <li data-thumb="admin/product_images/<?php echo $rowImage['image_name']; ?>">
                                            <img src="admin/product_images/<?php echo $rowImage['image_name']; ?>" />
                                        </li>
                                        <?php
                                    }
                                }
